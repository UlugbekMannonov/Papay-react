...
import RestaurantAipService from "../../apiServices/restaurantApiService";
...
export function AllRestaurants() {
  ...
  useEffect(() => {
    const restaurantService = new RestaurantAipService();
    restaurantService
      ...
      <Container>
        <Stack flexDirection={"column"} alignItems={"center"}>
          ...
          <Stack className={"all_res_box"}>
            <CssVarsProvider>
              {targetRestaurants.map((ele: Restaurant, index) => {
          ...
          <Stack className={"bottom_box"}>
            <img src={"/restaurant/line_two.svg"} className={"line_img"} />
            <Pagination
              count={
            ...
            />
            <img src={"/restaurant/line_two.svg"} className={"line_img_two"} />
          </Stack>
        </Stack>
      </Container>
    </div>
